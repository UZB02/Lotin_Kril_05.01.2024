<template>
    ...
    <div class="container sm:w-full md:w-full flex justify-center flex-col gap-2">
      <div class="btns flex items-center w-full gap-4 justify-center">
        <button @click="lotinKril" id="lotinkril"
          ...
          <span class="font-medium text-cente w-full transition-colors group-active:text-white">
            Lotin-Kril
          </span>
        </button>
        ...
        <button @click="krilLotin" id="krillotin"
          ...
          <span class="font-medium text-cente w-full transition-color  group-hover:text-black group-active:text-white">
            Крил-Лотин
          </span>
        </button>
      </div>
      <div class="texts flex items-center justify-center gap-3">
        <div class="texarea w-full flex  flex-col gap-1">
          ...
          <textarea id="OrderNotes" autofocus v-model="texarea" :rows="15" @input="() => {
            ...
            class="h-full  rounded-lg  align-top shadow-lg sm:text-sm w-full text-sm border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
  ...
  <footer class="p-4 shadow-inner flex items-center justify-center bg-slate-900">
    ...
    <div class="svg flex items-center justify-center gap-2">
      <!-- telegram -->
      <a href="https://t.me/MDdveloper" target="_blank">
              <svg width="24px" class="hover:scale-110" height="24px" fill="white" version="1.1"
      ...
      <!-- instagram -->
      <svg xmlns="http://www.w3.org/2000/svg" class="hover:scale-110" fill="white" width="24" height="24"
        viewBox="0 0 24 24">
        <path
...
const texarea = ref(route.query.q || '')
...
const lk = () => {
  ...
  if (texarea.value.length > 5000) {
    ...
    result.value = k
    router.push({ query: { q: texarea.value, p: result.value } })
  }
}
const kl = () => {
  let s = texarea.value.length
